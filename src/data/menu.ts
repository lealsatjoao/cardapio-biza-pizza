...
export const esfihasDoces: MenuItem[] = [
  ...
  {
    numero: 23,
    nome: 'Kinder chocolate preto ou branco coberto com leite ninho',
    nomeEn: 'Kinder dark or white chocolate topped with milk powder',
    descricao: 'Creme de leite, chocolate ao leite OU chocolate branco, coberto com leite em pó (Ninho).',
    descricaoEn: 'Heavy cream, milk chocolate OR white chocolate topped with Brazilian powdered candy.',
  },
  {
    numero: 24,
    nome: 'Krot',
