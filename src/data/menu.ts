...
export const esfihasSalgadas: MenuItem[] = [
  {
    ...
    nomeEn: 'Sausage with cheese',
    descricao: 'Calabresa e mussarela.',
    descricaoEn: 'Sausage with mozzarella.',
  },
  {
    numero: 2,
    nome: 'Carne, tomate e cebola',
    nomeEn: 'Beef, tomato and onion',
    descricao: 'Carne, tomate e cebola.',
    descricaoEn: 'Meat, tomato and onion.',
  },
  {
    numero: 3,
    nome: 'Frango com catupiry',
    nomeEn: 'Chicken with Catupiry',
    descricao: 'Frango e catupiry.',
    descricaoEn: 'Chicken with Brazilian cheese.',
  },
  {
    numero: 4,
    nome: 'Bacon com queijo',
    nomeEn: 'Bacon with cheese',
    descricao: 'Bacon e queijo.',
    descricaoEn: 'Bacon with cheese.',
  },
  {
    numero: 5,
    nome: 'Brócolis com catupiry',
    nomeEn: 'Broccoli with Catupiry',
    descricao: 'Brócolis e catupiry.',
    descricaoEn: 'Broccoli with Brazilian cheese.',
  },
  {
    numero: 6,
    nome: 'Atum, cebola e milho',
    nomeEn: 'Tuna, onion and corn',
    descricao: 'Atum, cebola e milho.',
    descricaoEn: 'Tuna, onions and corn.',
  },
  {
    numero: 7,
    nome: 'Brócolis, bacon e catupiry',
    nomeEn: 'Broccoli, bacon and Catupiry',
    descricao: 'Brócolis, bacon e catupiry.',
    descricaoEn: 'Broccoli, bacon and Brazilian cheese.',
  },
  {
    numero: 8,
    nome: 'Calabresa, queijo e catupiry',
    nomeEn: 'Sausage, cheese and Catupiry',
    descricao: 'Calabresa, queijo e catupiry.',
    descricaoEn: 'Sausage, cheese and Brazilian cheese.',
  },
  {
    numero: 9,
    nome: 'Quatro queijos',
    ...
    descricaoEn: 'Four cheese.',
  },
  {
    numero: 10,
    nome: 'Presunto, ovo, cebola e queijo',
    nomeEn: 'Ham, egg, onion and cheese',
    descricao: 'Presunto, ovo, cebola e queijo.',
    descricaoEn: 'Ham, egg, onions and cheese.',
  },
  {
    numero: 11,
    nome: 'Palmito, bacon e parmesão',
    nomeEn: 'Heart of palm, bacon and parmesan',
    descricao: 'Palmito, bacon e parmesão.',
    descricaoEn: 'Palm hearts, bacon and parmesan.',
  },
  {
    numero: 12,
    nome: 'Camarão, queijo e catupiry',
    nomeEn: 'Shrimp, cheese and Catupiry',
    descricao: 'Camarão, queijo e catupiry.',
    descricaoEn: 'Shrimp, cheese and Brazilian cheese.',
    precoOverride: '$4,00 +Tax',
  },
  {
    numero: 13,
    nome: 'Espinafre com queijo',
    nomeEn: 'Spinach with cheese',
    descricao: 'Espinafre e queijo.',
    descricaoEn: 'Spinach with cheese.',
    precoOverride: '$4,00 +Tax',
  },
]
...
export const esfihasDoces: MenuItem[] = [
  {
    numero: 14,
    nome: 'Abacaxi com chocolate branco',
    nomeEn: 'Pineapple with white chocolate',
    descricao: 'Abacaxi, creme de leite e chocolate branco.',
    descricaoEn: 'Pineapple, heavy cream and white chocolate.',
  },
  {
    numero: 15,
    nome: 'Abacaxi caramelizado com canela',
    nomeEn: 'Caramelized pineapple with cinnamon',
    descricao: 'Abacaxi, creme de leite, caramelo e canela.',
    descricaoEn: 'Pineapple, heavy cream, caramel and cinnamon.',
  },
  {
    numero: 16,
    nome: 'Banana com chocolate preto',
    nomeEn: 'Banana with dark chocolate',
    descricao: 'Banana, creme de leite e chocolate ao leite.',
    descricaoEn: 'Bananas, heavy cream and milk chocolate.',
  },
  {
    numero: 17,
    nome: 'Banana com chocolate branco',
    nomeEn: 'Banana with white chocolate',
    descricao: 'Banana, creme de leite e chocolate branco.',
    descricaoEn: 'Bananas, heavy cream and white chocolate.',
  },
  {
    numero: 18,
    nome: 'Banana caramelizada com canela',
    nomeEn: 'Caramelized banana with cinnamon',
    descricao: 'Banana, creme de leite, caramelo e canela.',
    descricaoEn: 'Bananas, heavy cream, caramel and cinnamon.',
  },
  {
    numero: 19,
    nome: 'Beijinho',
    descricao: 'Creme de leite, coco, chocolate branco e leite condensado.',
    descricaoEn: 'Heavy cream, coconut, white chocolate and condensed milk.',
  },
  {
    numero: 20,
    nome: 'Chocolate branco',
    nomeEn: 'White chocolate',
    descricao: 'Creme de leite e chocolate branco.',
    descricaoEn: 'Heavy cream and white chocolate.',
  },
  {
    numero: 21,
    nome: 'Chocolate preto',
    nomeEn: 'Dark chocolate',
    descricao: 'Creme de leite e chocolate branco.',
    descricaoEn: 'Heavy cream and white chocolate.',
  },
  {
    numero: 22,
    nome: 'Confete',
    descricao: 'Creme de leite, chocolate ao leite e M&M\'s.',
    descricaoEn: "Heavy cream, milk chocolate and M&M's.",
  },
  {
    numero: 23,
    nome: 'Kinder chocolate branco',
    nomeEn: 'White Kinder chocolate',
    descricao: 'Creme de leite e chocolate branco, coberto com leite em pó (Ninho).',
    descricaoEn: 'Heavy cream and white chocolate topped with Brazilian powdered candy.',
  },
  {
    numero: 24,
    nome: 'Kinder chocolate preto',
    nomeEn: 'Dark Kinder chocolate',
    descricao: 'Creme de leite e chocolate ao leite, coberto com leite em pó (Ninho).',
    descricaoEn: 'Heavy cream and milk chocolate topped with Brazilian powdered candy.',
  },
  {
    numero: 25,
    nome: 'Krot',
    descricao: 'Chocolate ao leite coberto com amendoim.',
    descricaoEn: 'Milk chocolate covered in peanuts.',
  },
  {
    numero: 26,
    nome: 'Mesclada',
    descricao: 'Creme de leite, chocolate ao leite e chocolate branco.',
    descricaoEn: 'Heavy cream, milk chocolate and white chocolate.',
  },
  {
    numero: 27,
    nome: 'Prestígio',
    descricao: 'Creme de leite, coco e chocolate ao leite.',
    descricaoEn: 'Heavy cream, coconut and milk chocolate.',
  },
  {
    numero: 28,
    nome: 'Sedução',
    descricao: 'Creme de leite, chocolate branco, morango e leite condensado.',
    descricaoEn: 'Heavy cream, white chocolate, strawberries and condensed milk.',
  },
  {
    numero: 29,
    nome: 'Sensação',
    descricao: 'Creme de leite, chocolate ao leite e morango.',
    descricaoEn: 'Heavy cream, milk chocolate and strawberries.',
  },
  {
    numero: 30,
    nome: 'Tentação',
    descricao: 'Chocolate branco, chocolate ao leite, morango e leite condensado.',
    descricaoEn: 'White chocolate, milk chocolate, strawberry and condensed milk.',
  },
  {
    numero: 31,
    nome: 'Romeu e Julieta',
    descricao: 'Queijo com goiabada.',
    descricaoEn: 'Cheese with guava.',
  },
]
